...
import { filterCompanySliders } from "../../../../actions/filterActions"
...
class SliderInput extends Component {
	...
	setValue(e) {
		...
		if(this.props.type === 'Min') {
			this.props.filterCompanySliders(this.props.name, [value, this.props.range[1]])
		}
		else {
			this.props.filterCompanySliders(this.props.name, [this.props.range[0], value])
		}
...
export default connect(mapStateToProps, { filterCompanySliders, updateCompanyData })(SliderInput)